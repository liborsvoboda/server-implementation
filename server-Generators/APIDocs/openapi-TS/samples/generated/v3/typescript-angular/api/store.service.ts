...
export class StoreService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public placeOrder(body?: Order, id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe?: 'body', reportProgress?: boolean): Observable<Order>;
    public placeOrder(body?: Order, id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Order>>;
    public placeOrder(body?: Order, id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Order>>;
    public placeOrder(body?: Order, id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public placeOrderForm(body?: Order, id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe?: 'body', reportProgress?: boolean): Observable<Order>;
    public placeOrderForm(body?: Order, id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Order>>;
    public placeOrderForm(body?: Order, id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Order>>;
    public placeOrderForm(body?: Order, id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
